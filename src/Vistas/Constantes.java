...
public class Constantes {
    public static final String NOMBRE_FICHERO_PROPIEDADES = ".\\src\\DataAccessLayer\\Conexion\\ConfiguracionConexion.properties";
    public static final String SCRIPTCREABASEDATOS = "bddViveroScript.sql";
    public static final String RUTA_SCRIPT = ".\\";
    ...
    public static int [] OPCIONES_MENU_EDITAR_GESTOR = {0,5};
    public static int [] OPCIONES_MENU_CRUD_GESTOR = {0,3};
    public static int [] OPCIONES_MENU_CRUD_FACTURAS = {0,1};
    public static int [] OPCIONES_MENU_INFORMES = {0,2};
